...
public class PlacementsWithoutRepetitions<T>  implements Iterable<T[]>{
    private int[] combination;
    private T[] sequence;
    private int numberOfElements;
    private int kCombinations;

    public PlacementsWithoutRepetitions(int[] combination, T[] sequence, int numberOfElements, int kCombinations) {
        super();
    ...
    public Iterator<T[]> iterator() {
        class PlacementIterator implements Iterator<T[]> {
